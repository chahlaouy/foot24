<?php /* Template Name: player_choose_jouranlist */ ?>
<?php
	/**
...
<body class="bg-gray-700">
    ...
    <section class="wrapper mx-auto" x-data="playerChoose()" x-init="
        ...
        <div class="fixed bottom-0 left-0 z-50 p-12" x-show="isAllowedToVote">
            <div class="w-96 bg-gray-800 rounded-2xl text-gray-100 shadow-2xl p-8">
                ...
                <div>
                    <label for="" class="block">المؤسسة الاعلامية</label>
                    <input  type="text" class="w-full  py-3 bg-gray-700 rounded-xl my-4 px-2" placeholder="المؤسسة الاعلامية">
                </div>
    ...
    <script>
        function playerChoose(){
            return {
                players: [
                    {id: '1', name: "اللاعب 1", imgUrl: '<?php echo get_template_directory_uri() ?>' + '/assets/images/' + 'profile.png', scoreJournalist: 0},
                    {id: '2', name: "اللاعب 2", imgUrl: '<?php echo get_template_directory_uri() ?>' + '/assets/images/' + 'profile.png', scoreJournalist: 0},
                    {id: '3', name: "اللاعب 3", imgUrl: '<?php echo get_template_directory_uri() ?>' + '/assets/images/' + 'profile.png', scoreJournalist: 0},
                    {id: '4', name: "اللاعب 4", imgUrl: '<?php echo get_template_directory_uri() ?>' + '/assets/images/' + 'profile.png', scoreJournalist: 0},
                    {id: '5', name: "اللاعب 5", imgUrl: '<?php echo get_template_directory_uri() ?>' + '/assets/images/' + 'profile.png', scoreJournalist: 0},
                ],
                ...
                submitVoting(){
                    ...
                    if(this.isUserRegistred){
                        ...
                        if(this.isChoosingIsComplete){
                            ...
                            xhr.open("POST", 'http://wp.foot24.online/update-player-journalist/', true);
                ...
                saveUserInfo(){
                    if((this.userInfo.username != "") && (this.userInfo.phone != "") && (this.userInfo.cin != "")){
                        var xhr = new XMLHttpRequest();
                        xhr.open("POST", 'http://wp.foot24.online/create-user/', true);
                        xhr.setRequestHeader('Content-Type', 'application/json');
